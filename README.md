> I'm not responsible for bricked your device, eMMC read errors, or if a missile hits your house. DO IT AT YOUR OWN RISK (but assuming you're going to experiment with it anyway, just do what you want, but be careful).

# LineageOS for Alcatel OneTouch Pixi 3 (3.5)
This repository contains my fully functional custom ROM for the Alcatel OneTouch Pixi 3 (the 3.5-inch model).


_MADE IN ARGENTINA WITH LOVE FOR THE COMMUNITY <3_
